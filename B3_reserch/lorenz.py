...
def kutta2(i,im,x,y,z,h):
    ...
    im.append(ax.scatter(x2,y2,z2,"r"))
...
if __name__=='__main__':
    ...
    x,y,z = loop(n,x0,y0,z0,h)
    ax.set_xlim(-20,20)
    ax.set_ylim(-20,20)
    ax.set_zlim(0,40)
    
    im = []
    anim = animation.FuncAnimation(fig, kutta2,fargs=(im,x,y,z,h),frames=n,interval=0.001,repeat=False)
